...
export default function music() {
    return (
        ...
        <div
         className='sm:w-full md:w-[70%] sm:p-5 md:p-5 sm:h-auto md:h-[400px] flex sm:flex-col md:flex-row sm:justify-start
          md:justify-center sm:items-start md:items-center bg-black'>
              {/*Left Box*/}
